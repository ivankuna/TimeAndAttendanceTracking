...
public class EmployeeController {
    ...
    private List<Data> defineDataList() {
        ...
        ;
        dataList.add(new Data("12.", "Ukupno sati rada za Ponedjeljak", "mondayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("13.", "Ukupno sati rada za Utorak", "tuesdayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("14.", "Ukupno sati rada za Srijedu", "wednesdayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("15.", "Ukupno sati rada za Četvrtak", "thursdayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("16.", "Ukupno sati rada za Petak", "fridayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("17.", "Ukupno sati rada za Subotu", "saturdayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
        dataList.add(new Data("18.", "Ukupno sati rada za Nedjelju", "sundayWorkHours", "", "", "", "number-input", "false", "", items, "false"));
        ;
